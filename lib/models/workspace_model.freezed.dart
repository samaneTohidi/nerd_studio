...
class _$WorkspaceModelImpl implements _WorkspaceModel {
  ...
  @override
  String toString() {
    return 'WorkspaceModel(id: $id, isBase: $isBase, isDefault: $isDefault, workspace: $workspace, user: $user, role: $role)';
  }
...
abstract class _WorkspaceModel implements WorkspaceModel {
  const factory _WorkspaceModel(
      ...
      required final RoleModel role}) = _$WorkspaceModelImpl;
